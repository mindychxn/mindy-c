...
export default function Contact() {
  ...
  return (
    <section id='contact'>
      <div className='contact h-screen bg-black flex flex-col gap-8 justify-center items-center'>
        ...
        <div className='font-DMSans sm:text-xl xl:text-2xl font-light text-white w-2/3 text-center'>
          Thanks for getting to know me! I'd love to get to know you too. Please feel free to send me a message.
        </div>
        <form
          ref={formRef}
          method='POST'
        ...
        >
          ...
          <input type="hidden" name="redirect" value="https://yourwebsite.com/thanks.html"></input>
          <input
            name='name'
            type='text'
          ...
          <div className='font-light font-DMSans text-sm tracking-wide text-[#ffffffb5]' ref={resultRef} />
        </form>
      </div>
    </section>
  );
